...
const Color kColorMain = Color(0xff406ab3);
const Color kColorBlack = Colors.black;
Color? kColorGrey = const Color(0xffE6E6E6);
...
const Color kColorMainRed = Colors.red;
const Color kColorOffWhite = Color(0xffF3F6FB);
